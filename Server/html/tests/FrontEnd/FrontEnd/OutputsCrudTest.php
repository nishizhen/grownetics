...
class OutputsCrudTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testOutputCrud() {
        ...
        $this->driver->get( 'http://nginx/outputs' );
        ...
        $this->driver->wait()->until(
            WebDriverExpectedCondition::titleContains('Grownetics - Outputs')
        );

        # Add an output

        $this->driver->get( 'http://nginx/outputs/add' );
        ...
        $this->driver->findElement(
            WebDriverBy::linkText('Test add output')
        )->click();
        ...
        $this->driver->wait()->until(
            WebDriverExpectedCondition::presenceOfAllElementsLocatedBy(
                WebDriverBy::linkText('Test add output edited')
            )
        );
