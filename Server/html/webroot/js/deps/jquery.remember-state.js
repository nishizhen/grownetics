  ...
  var remember_state = {
    ...
    _defaultNoticeDialog: function() {
      return $("<p />", { "class": "remember_state" })
        .html("Restore previously entered info? <button type='button' class='btn btn-success btn-xs fa fa-check'></button> <button type='button' class='btn btn-danger btn-xs fa fa-times'></button>");
    },
    noticeDialog: null,
