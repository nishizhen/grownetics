...
void setup()
{
  ...
  if (debug == true)
  {
    ...
    // JsonArray& data3 = root.createNestedArray("i5");
    // data3.add("pH");
    // setPins(data3,pinsType5);
    // setPins(data3,pinsType7);
    // setPins(data3,pinsType6);
    // setPins(data3,pinsType12);
  }
}
...
{                                            //function to parse and call I2C commands.
  ...
  { // in case the stamp takes longer to process than we expected
