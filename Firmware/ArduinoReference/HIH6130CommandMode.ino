...
void loop(void)
{
    ...
    Serial.println("Done reading data. Set Alarms");
    ...
    w = read_word(0x1c);
    Serial.print(0x1c, HEX);
    Serial.print("  ");
    print_hex(w, 16);
    Serial.println();
  
    write_word(0x5c, 0x2053);
    ...
    digitalWrite(4, LOW);  // turn on power
    delay(1000);
    digitalWrite(4, HIGH);  // turn on power
    delay(1000);
